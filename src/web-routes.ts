...
export const webRoutes = [
  ...
  { method: "GET" as const, path: "/trails", config: placemarksController.index },
  { method: "POST" as const, path: "/trails", config: placemarksController.trails },
  { method: "GET" as const, path: "/report", config: placemarksController.report },
